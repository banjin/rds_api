...
'''
        ...
        # # 单表参数查询
            ...
            return """<?xml version="1.0" encoding="UTF-8"?><root><head><code>1</code><msg>null</msg></head><body><result><ywcode>1</ywcode><ywmsg>u"数据查询成功"</ywmsg><dataObj><bm>usera.table01</bm><jgxtlb>10</jgxtlb><bmms>u"表01"</bmms><clcjbj>1</clcjbj><sjczd>starttime</sjczd><clqsrq>2017-12-05 00:00:00</clqsrq><clgltj>where id>=0</clgltj><clwcbj>0</clwcbj><zlkhdgllx>plsqldev</zlkhdgllx><zlinsert>1</zlinsert><zlupdate>1</zlupdate><zldelete>1</zldelete><cjsj>{create_time}</cjsj><gxsj>{update_time}</gxsj></dataObj><dataObj><bm>usera.table03</bm><jgxtlb>10</jgxtlb><bmms>u"表03"</bmms><clcjbj>1</clcjbj><sjczd>starttime</sjczd><clqsrq>2017-12-07 00:00:00</clqsrq><clgltj>where id>=0</clgltj><clwcbj>0</clwcbj><zlkhdgllx>jdbc</zlkhdgllx><zlinsert>0</zlinsert><zlupdate>1</zlupdate><zldelete>0</zldelete><cjsj>{create_time}</cjsj><gxsj>{update_time}</gxsj></dataObj> </result></body></root>""".format(create_time=create_time, update_time=update_time)
