...
'''
        ...
        # # 单表参数查询
            ...
            return """<?xml version="1.0" encoding="UTF-8"?><root><head><code>1</code><msg>null</msg></head><body><result><ywcode>1</ywcode><ywmsg>u"数据查询成功"</ywmsg><dataObj><bm>veh_check</bm><jgxtlb>10</jgxtlb><bmms>表05</bmms><clcjbj>1</clcjbj><sjczd>dlsj</sjczd><clqsrq>2018-04-10 20:00:00</clqsrq><clgltj>where id>=0</clgltj><clwcbj>0</clwcbj><zlkhdgllx>jdbc</zlkhdgllx><zlinsert>0</zlinsert><zlupdate>1</zlupdate><zldelete>0</zldelete><cjsj>{create_time}</cjsj><gxsj>{update_time}</gxsj></dataObj></result></body></root>""".format(
